    ...
    <div className={styles.wrap}>
      ...
      <div className={styles.trend}>
        <div className={styles.out}>
          <h1 className={styles.trendtitle}>TRENDING ON RT</h1>
          <a
            href="https://editorial.rottentomatoes.com/article/everything-we-know-about-guardians-of-the-galaxy-vol-3/"
            className={styles.trendtxt}
          >
